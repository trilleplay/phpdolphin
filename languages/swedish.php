...
$LNG['user_success'] = 'Ny användare skapad';
$LNG['user_exists'] = 'Någon har redan tagit detta användarnamn';
$LNG['email_exists'] = 'Denna email används redan';
$LNG['all_fields'] = 'Vänligen fyll alla fält';
$LNG['user_alnum'] = 'Användarnamnet får bara bestå av bokstäver och siffror';
$LNG['user_too_short'] = 'Användarnamnet måste vara mellan 3 till 32 karaktärer';
$LNG['user_limit'] = 'Förmånga konto skapat på den här IP-addressen';
$LNG['invalid_email'] = 'Ogiltig email';
$LNG['invalid_user_pw'] = 'Ogiltigt användarnamn eller lösenord';
$LNG['invalid_captcha'] = 'Ogiltigt svar på captcha';
$LNG['activate_email'] = 'En aktiveringslänk har skickats till din email';
$LNG['account_activated'] = 'Ditt konto har aktiverats';
$LNG['log_out'] = 'Logga ut';
$LNG['hello'] = 'Hej';
$LNG['register'] = 'Registrera';
$LNG['login'] = 'Logga in';
$LNG['connect'] = 'Anslut';
$LNG['password'] = 'Lösenord';
$LNG['username'] = 'Användarnamn';
$LNG['email'] = 'Email';
$LNG['captcha'] = 'Captcha';
$LNG['username_or_email'] = 'Användarnamn eller email';
$LNG['welcome_title'] = 'Välkommen';
$LNG['welcome_desc'] = 'till vår sociala medie';
$LNG['welcome_about'] = 'Dela dina minnen, anslut med andra, få nya vänner.';
$LNG['forgot_password'] = 'Glömt ditt lösenord';
$LNG['remember_me'] = 'Kom ihåg mig';
$LNG['all_rights_reserved'] = 'Alla rättigheter resarverade';

$LNG['welcome_one'] = 'Anslut';
$LNG['welcome_two'] = 'Dela';
$LNG['welcome_three'] = 'Hitta';
$LNG['welcome_one_desc'] = 'Anslut med din familj, vänner och dela dinna minnen';
$LNG['welcome_two_desc'] = 'Dela vad som är nytt och dela minnen med dina vänner';
